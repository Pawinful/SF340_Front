  ...
  return (
    <div className="w-full h-[8vh] bg-[#8A2A2B] flex items-center justify-between text-white px-6 sticky top-0 shadow-md">
      ...
      <div className="hidden md:flex items-center space-x-8 text-lg ml-auto">
        <Link
          to="/"
          className="hover:bg-white hover:text-[#8A2A2B] px-3 py-1 rounded-sm font-semibold"
        >
          Home
        </Link>
        <Link
        ...
        <div className="relative">
          <button
            ...
            className="flex rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none cursor-pointer"
          >
            <img
      ...
      {menuOpen && (
        <div className="absolute top-[8vh] left-0 w-full bg-white flex flex-col items-center py-4 space-y-4 md:hidden shadow-md">
          <a href="#" className="text-lg text-[#8A2A2B] hover:text-gray-600">
            Home
          </a>
          <a href="#" className="text-lg text-[#8A2A2B] hover:text-gray-600">
            My Booking
